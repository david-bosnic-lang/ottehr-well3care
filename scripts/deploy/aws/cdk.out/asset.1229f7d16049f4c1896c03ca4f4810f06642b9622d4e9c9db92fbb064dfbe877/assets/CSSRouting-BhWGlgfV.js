...
var b1 = Object.getOwnPropertyDescriptors;
var r1 = Object.getOwnPropertySymbols;
var S1 = Object.prototype.hasOwnProperty,
  L1 = Object.prototype.propertyIsEnumerable;
var a1 = (t, n, s) => (n in t ? Z1(t, n, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (t[n] = s)),
  p = (t, n) => {
    for (var s in n || (n = {})) S1.call(n, s) && a1(t, s, n[s]);
    if (r1) for (var s of r1(n)) L1.call(n, s) && a1(t, s, n[s]);
    return t;
  },
  f = (t, n) => I1(t, b1(n));
import {
...
const x2 = E(h2),
  u2 = () => {
    ...
    return { filledPages: n, currentPage: a };
  },
  p2 = () => {
    const { filledPages: t, currentPage: n } = u2(),
      { interactionMode: s } = k(),
      a = Object.values(g1),
      i = a.filter((o) => o.modes.includes(s)),
      h = () => {
        var o;
        return !((o = a.find((l) => location.pathname.includes(l.path))) != null && o.modes.includes(s));
      };
    if (s !== 'intake' || !i.length || h()) return e.jsx(e.Fragment, {});
    const u = i.map((o) => ({ text: o.text, link: o.path, isHighlighted: t.includes(o.path), isActive: o.path === n }));
    return e.jsx(P1, { items: u });
  };
var Z = {},
  c1;
function g2() {
...
const C2 = E(v2),
  m2 = () => {
    const [t, n] = m1.useState(!1);
    return { isOpen: t, openModal: () => n(!0), closeModal: () => n(!1), InternalNotesModal: f2 };
  },
  f2 = ({ open: t, onClose: n }) =>
    e.jsxs(R1, {
      open: t,
        ...
        e.jsxs(N1, {
          children: [
            e.jsxs(j, {
              ...
              children: [
                e.jsx(N, { variant: 'h4', component: 'div', children: 'Internal Notes' }),
                e.jsx(U, {
                  sx: { color: 'grey.500' },
                  edge: 'end',
                  color: 'inherit',
            ...
            e.jsxs(j, {
              ...
              alignItems: 'center',
              children: [
                e.jsx(C2, { color: 'primary' }),
                e.jsx(N, {
                  variant: 'body2',
                  color: 'textSecondary',
                  sx: { ml: 1 },
                  children: 'Not visible to the patient',
                }),
              ],
            }),
          ],
        }),
        e.jsx(T1, { sx: { mt: -3 }, children: e.jsx(j2, {}) }),
      ],
    }),
  d1 = {
    apiConfig: {
      ...
      searchParams: {
        ...
        _sort: '-_lastUpdated',
        _count: 1e3,
        _tag: ''.concat(v1, '/').concat(W.INTERNAL, '|').concat(C1),
      },
    },
    locales: {
      ...
      getAddButtonText: (t) => (t ? 'Saving Internal Note...' : 'Save Internal Note'),
      getMoreButtonText: (t) => (t ? 'See less' : 'See more'),
      getDeleteModalTitle: (t) => 'Delete '.concat(t),
      getDeleteModalContent: (t) => 'Are you sure you want to permanently delete this '.concat(t, '?'),
      getKeepButtonText: () => 'Keep',
      getDeleteButtonText: (t) => (t ? 'Deleting...' : 'Delete'),
      getLeaveButtonText: () => 'Leave',
      getSaveButtonText: (t) => (t ? 'Saving...' : 'Save'),
      getErrorMessage: (t, n) => 'Error during '.concat(n, ' ').concat(t, '. Please try again.'),
      getGenericErrorMessage: () => 'An error occurred while saving the information. Please try again.',
    },
  },
  j2 = () => e.jsx(B1, { separateEncounterNotes: !1, apiConfig: d1.apiConfig, locales: d1.locales }),
  w2 = e.jsx('svg', {
    width: '20',
    height: '20',
    fill: 'none',
  ...
  A2 = ({ encounterId: t }) => {
    var l, x;
    const n = _1(),
      { isOpen: s, openModal: a, InternalNotesModal: i, closeModal: h } = m2(),
      { data: u } = O1(
        {
          apiClient: n,
          encounterId: t,
      ...
      o = (x = (l = u == null ? void 0 : u.notes) == null ? void 0 : l.length) != null ? x : 0;
    return e.jsxs(e.Fragment, {
      children: [
        e.jsxs(j1, {
          ...
          startIcon: w2,
          onClick: a,
          sx: { '& .button-text': { display: 'none', '@media (min-width: 1179px)': { display: 'inline' } } },
          children: [e.jsx('span', { className: 'button-text', children: 'Internal Notes' }), ' (', o, ')'],
        }),
        e.jsx(i, { open: s, onClose: h }),
      ],
    });
  },
  M2 = ({ isDisabled: t, handleSwitchMode: n, nextMode: s }) =>
    e.jsx(j1, {
      'data-testid': S.cssHeader.switchStatusButton(s),
      variant: 'contained',
      disabled: t,
      onClick: n,
  ...
  V2 = $(N)(({ theme: t }) =>
    f(p({}, (t == null ? void 0 : t.typography).h4), {
      textAlign: 'left',
      fontWeight: 'bold',
      color: t.palette.primary.dark,
    })
  ),
  C = $(N)(({ theme: t }) => ({ fontSize: '14px', fontWeight: 400, color: t.palette.text.secondary })),
  h1 = $(j)({ display: 'flex', alignItems: 'baseline', gap: '8px' }),
  v = (t, n = '', s = !1, a = 'N/A') => (!t || (s && t) ? ''.concat(n, ': ') : '') + (t || a),
  Z2 = () => {
    var t1, n1, s1, i1;
    const { id: t } = z(),
      n = G(),
      {
        resources: { appointment: s, patient: a },
        mappedData: i,
        visitState: h,
        refetch: u,
      } = X(t),
      { encounter: o } = h,
      { chartData: l } = D1(T, ['chartData']),
      x = o == null ? void 0 : o.id,
      g = v(i == null ? void 0 : i.patientName, 'Name'),
      m = v(i == null ? void 0 : i.pronouns, 'Pronouns'),
      w = v(i == null ? void 0 : i.gender, 'Gender'),
      y = v(i == null ? void 0 : i.preferredLanguage, 'Lang'),
      A = v(i == null ? void 0 : i.DOB, 'DOB', !0),
      P = v(
        (s1 =
          (n1 = (t1 = l == null ? void 0 : l.allergies) == null ? void 0 : t1.filter((H) => H.current === !0)) == null
            ? void 0
            : n1.map((H) => H.name)) == null
          ? void 0
          : s1.join(', '),
        'Allergy',
        !0,
      ...
      M = v(s == null ? void 0 : s.description, 'Reason for Visit'),
      r = v(a == null ? void 0 : a.id),
      [c, q] = K.useState(void 0),
      { interactionMode: e1, setInteractionMode: y1 } = k(),
      F = e1 === 'intake' ? 'provider' : 'intake',
      A1 = e1 === 'intake' ? L.Attender : L.Admitter,
      { isEncounterUpdatePending: M1, handleUpdatePractitioner: H1 } = Y(o, 'start', A1),
      V1 = async () => {
        try {
          if (!t) return;
          await H1(), u(), y1(F, !0);
          ...
          console.log(H.message),
            J('An error occurred trying to switch to '.concat(F, ' mode. Please try again.'), { variant: 'error' });
        }
      };
    return e.jsx(H2, {
      'data-testid': S.cssHeader.container,
      children: e.jsxs(d, {
        container: !0,
        spacing: 2,
        sx: { padding: '0 18px 0 4px' },
        children: [
          e.jsx(d, {
            item: !0,
            xs: 12,
              ...
              children: [
                e.jsx(d, {
                  ...
                  children: e.jsxs(d, {
                    ...
                    spacing: 2,
                    children: [
                      e.jsx(d, { item: !0, children: e.jsx(E1, { appointmentID: t, onStatusChange: q }) }),
                      e.jsx(d, {
                        item: !0,
                        children: e.jsxs(C, {
                          children: [
                ...
                e.jsx(d, { item: !0, children: e.jsx(U, { onClick: () => n('/visits'), children: e.jsx(f1, {}) }) }),
              ],
            }),
          }),
          e.jsx(d, {
            ...
            children: e.jsxs(d, {
              ...
              spacing: 2,
              children: [
                e.jsx(d, { item: !0, children: e.jsx($1, { appointmentID: t }) }),
                e.jsxs(d, {
                  item: !0,
                  xs: !0,
                  children: [
                    e.jsxs(h1, {
                      children: [
                        e.jsx(V2, { 'data-testid': S.cssHeader.patientName, children: g }),
                        e.jsx(C, { sx: { fontWeight: 500 }, children: A }),
                        ' |',
                        e.jsx(C, {
                          noWrap: !0,
                          sx: {
                            fontWeight: (i1 = l == null ? void 0 : l.allergies) != null && i1.length ? 700 : 400,
                            maxWidth: '250px',
                          },
                          children: P,
                        }),
                ...
                e.jsxs(d, {
                  item: !0,
                  sx: { '@media (max-width: 1179px)': { display: 'flex', flexDirection: 'column', gap: 0.5 } },
                  children: [
                    e.jsx(M2, { isDisabled: !t || M1, handleSwitchMode: V1, nextMode: F }),
                    x ? e.jsx(A2, { encounterId: x }) : null,
                  ],
                }),
              ],
            }),
  ...
  I2 = ({ isDisabled: t, handleCompleteIntake: n, status: s }) =>
    e.jsx(q1, {
      title: s !== 'intake' ? 'Only available in Intake status' : null,
      sx: { width: '120px', textAlign: 'center' },
      placement: 'top',
      children: e.jsx(F1, {
        sx: { alignSelf: 'center' },
        children: e.jsx(Q, {
          'data-testid': S.sideMenu.completeIntakeButton,
          variant: 'contained',
  ...
  b2 = ({ direction: t }) =>
    e.jsxs('svg', {
      ...
      xmlns: 'http://www.w3.org/2000/svg',
      children: [
        e.jsx('circle', { cx: '20', cy: '20', r: '20', fill: '#2169F5', fillOpacity: '.04' }),
        e.jsx('mask', {
          id: 'a',
          ...
          width: '24',
          height: '24',
          children: e.jsx('path', { fill: '#D9D9D9', d: 'M8 8h24v24H8z' }),
        }),
        e.jsx('g', {
          mask: 'url(#a)',
          children: e.jsx('path', {
  ...
  S2 = {
    ...
    'External Labs': e.jsx(x2, {}),
    Stethoscope: e.jsx('svg', {
      width: '20',
      height: '20',
      viewBox: '0 0 20 20',
      fill: 'none',
    ...
    'Oystehr AI': e.jsx('img', { src: Q1, style: { width: '22px' } }),
  },
  x1 = 244,
  L2 = w1('div')(({ theme: t }) =>
    f(p({ display: 'flex', alignItems: 'center', padding: t.spacing(0, 1) }, t.mixins.toolbar), {
      justifyContent: 'flex-end',
    })
  ),
  k2 = w1(Q)(({ theme: t, isactive: n }) =>
    p(
      {
        display: 'flex',
        width: '100%',
        ...
        '& .MuiListItem-root:hover': { backgroundColor: B(t.palette.primary.main, 0.03) },
        '&.Mui-disabled': { color: t.palette.text.primary },
      },
      n === 'true' && {
        color: t.palette.primary.main,
        borderRight: '2px solid '.concat(t.palette.primary.main),
        backgroundColor: B(t.palette.primary.main, 0.05),
  ...
  P2 = () => {
    const t = G(),
      ...
      { interactionMode: a } = k(),
      { id: i } = z(),
      { visitState: h, refetch: u } = X(i),
      { chartData: o } = W1(T, ['chartData']),
      { appointment: l, encounter: x } = h,
      g = l && x ? U1(l, x) : void 0,
      { isEncounterUpdatePending: m, handleUpdatePractitioner: w } = Y(x, 'end', L.Admitter),
      y = async () => {
        try {
          await w(), await u();
        } catch (r) {
          console.log(r.message),
            J('An error occurred trying to complete intake. Please try again.', { variant: 'error' });
        }
      },
      A = () => {
        s(!n);
      ...
      M = ((r) =>
        r
          .map((c) => ({
            text: c.text,
            icon: S2[c.iconKey],
            to: c.sidebarPath || c.path,
            activeCheckPath: c.activeCheckPath,
            visibility: new Set(c.modes),
          }))
          .filter((c) => c.visibility.has(a)))(
        Object.values(g1)
          .filter((r) => !r.isSkippedInNavigation)
          .filter((r) => r.path !== z1.OTTEHR_AI || (o == null ? void 0 : o.aiChat) != null)
      );
    return e.jsxs(G1, {
      variant: 'permanent',
      open: n,
      ...
      children: [
        e.jsx(L2, {
          sx: f(
            p(
              ...
              n ? { justifyConent: 'end', paddingRight: '10px' } : { justifyContent: 'center', paddingRight: '0px' }
            ),
            { borderBottom: '1px solid #e0e0e0' }
          ),
          children: e.jsx(U, {
            sx: { padding: 0 },
            onClick: A,
            children: e.jsx(b2, { direction: n ? 'left' : 'right' }),
          }),
        }),
        e.jsx(X1, {
          sx: { padding: '0px' },
          children: M.map((r) => {
            const c = (r == null ? void 0 : r.activeCheckPath) || r.to;
            return e.jsx(
              k2,
              {
                isactive: location.pathname.includes(c).toString(),
                disabled: location.pathname.includes(c),
                onClick: () => {
                ...
                children: e.jsxs(K1, {
                  'data-testid': S.sideMenu.sideMenuItem(r.to),
                  sx: { width: '100%', height: 'inherit' },
                  children: [
                    e.jsx(Y1, { sx: { minWidth: 40 }, children: r.icon }),
                    e.jsx(J1, { primary: r.text, sx: { opacity: n ? 1 : 0 } }),
                  ],
                }),
              },
              r.text
        ...
        e.jsx('br', {}),
        e.jsx(I2, { isDisabled: !i || m || g !== 'intake', handleCompleteIntake: y, status: g }),
      ],
    });
  };
var I = {},
...
function R2() {
  ...
  var n = t(O()),
    s = D();
  return (
    (I.default = (0, n.default)(
      (0, s.jsx)('path', { d: 'M15.41 7.41 14 6l-6 6 6 6 1.41-1.41L10.83 12z' }),
      'ChevronLeft'
    )),
    I
  );
...
function B2() {
  ...
  var n = t(O()),
    s = D();
  return (
    (b.default = (0, n.default)(
      (0, s.jsx)('path', { d: 'M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z' }),
      'ChevronRight'
    )),
    b
  );
...
const O2 = E(_2),
  D2 = () => {
    const { id: t } = z(),
      { visitState: n, refetch: s } = X(t),
      { encounter: a } = n,
      i = e2(),
      {
        goToNext: h,
        goToPrevious: u,
        isNavigationHidden: o,
        isFirstPage: l,
        isLastPage: x,
        interactionMode: g,
      ...
      y = g === 'intake' ? L.Admitter : L.Attender,
      { isEncounterUpdatePending: A, handleUpdatePractitioner: P } = Y(a, 'end', y),
      [M, r] = m1.useState(!1),
      c = async () => {
        try {
          r(!0), x && g === 'intake' && (await P()), h(), await s();
        } catch (q) {
    ...
    return o
      ? e.jsx(e.Fragment, {})
      : e.jsx(j, {
          sx: { display: 'flex', flexDirection: 'column', margin: '0 0 0 -20px', width: 'calc(100% + 20px)' },
          children: e.jsxs(j, {
            sx: { display: 'flex', height: '48px', boxShadow: '0px 0px 4px 2px rgba(0,0,0,0.1)' },
            children: [
              e.jsx(Q, {
                disabled: l || m,
                startIcon: e.jsx(T2, { sx: { width: '32px', height: '32px' } }),
                onClick: u,
                sx: f(
                  p(
                    {
                      ...
                      borderRadius: 0,
                      '&:hover': { backgroundColor: B(i.palette.primary.light, 0.1) },
                  ...
                  { fontSize: '16px', borderRight: '1px solid '.concat(i.palette.primary.main) }
                ),
                children: 'Back',
              }),
              e.jsx(t2, {
                disabled: m || A || (x && g === 'provider'),
                loading: M,
                endIcon: e.jsx(O2, { sx: { width: '32px', height: '32px' } }),
                onClick: c,
                sx: f(
                  p(
                    {
                      ...
                      borderRadius: 0,
                      '&:hover': { backgroundColor: B(i.palette.primary.light, 0.24) },
                      color: i.palette.primary.main,
                      pr: 3,
                      fontWeight: 'bold',
                      textTransform: 'none',
  ...
  E2 = { display: 'flex', flexDirection: 'column', height: '100vh' },
  $2 = { display: 'flex', flexGrow: 1, overflow: 'hidden' },
  q2 = { flexGrow: 1, padding: 0, flex: 1, display: 'flex', flexDirection: 'column', overflowX: 'auto' },
  F2 = () => {
    const { encounter: t, chartData: n } = T(),
      s = K.useRef(!0);
    return (
      n2(),
      s2({
        encounterId: t.id,
        onSuccess: (a) => {
          T.setState({ chartData: p(p({}, n), a) }), (s.current = !1);
        },
        onError: (a) => {
          console.error(a);
        },
          ...
          e.jsxs('div', {
            ...
            children: [
              ...
              e.jsxs('div', {
                ...
                children: [
                  e.jsxs('div', {
                    style: { flex: 1, overflowY: 'auto', padding: '20px 20px 24px 20px' },
                    children: [e.jsx(p2, {}), e.jsx(i2, {})],
                  }),
                  e.jsx(D2, {}),
                ],
              }),
  ...
  W2 = () => {
    const t = a2(),
      n = G(),
      { availableRoutes: s, isLoading: a } = k();
    return t.isPending || a
      ? e.jsx(o2, {})
      : t.view
      ? e.jsx(l2, {
          flagsToSet: { css: !0 },
          children: e.jsx(c2, {
            children: e.jsxs(R, {
              element: e.jsx(F2, {}),
              children: [
                e.jsx(R, { index: !0, element: e.jsx(o1, { to: s[0].path, replace: !0 }) }),
                s.map((i) => e.jsx(R, { path: i.path, element: i.element }, i.path)),
                e.jsx(R, { path: '*', element: e.jsx(o1, { to: s[0].path, replace: !0 }) }),
              ],
            }),
          }),
        })
