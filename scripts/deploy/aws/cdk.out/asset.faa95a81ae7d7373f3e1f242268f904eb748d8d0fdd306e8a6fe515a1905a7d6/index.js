...
var f = Object.create,
  ...
  l = (t, e, o) => (
    (o = t != null ? f(w(t)) : {}), d(e || !t || !t.__esModule ? i(o, 'default', { value: t, enumerable: !0 }) : o, t)
  ),
...
async function D(t, e) {
  return new Promise((o, r) => {
    try {
      let s = y.request(t, (n) => {
        n.resume(),
          !n.statusCode || n.statusCode >= 400 ? r(new Error(`Unsuccessful HTTP response: ${n.statusCode}`)) : o();
      });
...
async function _(t) {
  try {
    let e = (await c.getBucketPolicy({ Bucket: t }))?.Policy ?? x,
      o = JSON.parse(e);
    o.Statement.push({ Principal: '*', Effect: 'Deny', Action: ['s3:PutObject'], Resource: [`arn:aws:s3:::${t}/*`] }),
